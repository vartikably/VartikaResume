...
const Body = ()=>{
    return(
        <div className="body-container flex justify-center px-4 items-center my-28">
            <div className="img-container">
                <img src={Vartika} alt='Vartika Agarwal' className='rounded-full w-56 mx-24'/>
            </div>
            <div className="details-container flex flex-col text-left">
