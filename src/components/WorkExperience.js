 import { companyImage2 } from "../Utils/Constant";
import birlasoft from '../resource/Birlasoft.jpg';
import tcs from "../resource/TCS.png";
    ...
    return(
        <div className="workexperience-container">
            <div className="flex flex-wrap  flex-col">
                ...
                <div className="flex flex-col md:flex-row m-4 justify-center gap-10">
                <div className="flex flex-col bg-white border border-gray-200 rounded-lg md:items-start items-center shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <img src={birlasoft} className="text-center size-20 align-middle" alt="Birlasoft Ltd"/>
                ...
                <div className="flex  flex-col px-4 bg-white border border-gray-200 rounded-lg  md:items-start items-center shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <img src={tcs} className="size-20 align-middle" alt="Tata Consultancy Limited"/>
                    <div className="text-justify px-8 py-2 flex flex-col">
