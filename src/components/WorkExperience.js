        ...
        <div className="workexperience-container">
            <div className="flex flex-wrap  flex-col">
                ...
                <div className="flex flex-col bg-white border border-gray-200 rounded-lg md:items-start items-center shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <img src={companyImage1} className="text-center size-20 align-middle" alt="Birlasoft Ltd"/>
                ...
                <div className="flex flex-wrap flex-col px-4 bg-white border border-gray-200 rounded-lg  md:items-start items-center shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
